...
![](src/image.png)  
Hal tersebut terjadi karena gazebo merupakan tools milik ubuntu sedangkan distro linux saya adalah Kali Linux. Saya dapat mengatasi masalah tersebut dengan menggunakan docker image dari ROS karena gazebo merupakan dependency bawaan ROS  
- Secara pengerjaan, saya tidak mengalami banyak kendala. Terutama pada bagian metode 1 yang dapat cukup dilakukan dengan memetakan _waypoint_ hingga berbentuk angka 8. Saya pun senang mengutak-atik Ardupilot dan melihat melalui gazebo bagaimana drone saya terbang. Namun pada pengerjaan metode 2, bebarengan dengan jadwal perjalanan saya kembali ke Jatinangor menggunakan bis sehingga saya hanya mengerjakan secukupnya baterai laptop saya dengan logika sesederhana mungkin memprioritaskan jalurnya berbentuk angka 8. Saya juga sepertinya mengalami kesalahpahaman dan hanya merekam proses running metode 1 dan tidak metode 2 juga  
### Praktikum ROS  
- Saya mampu mengerjakan bagian A dengan cukup percaya diri dengan pemahaman konsep dasar OOP dan design thinking saya yang cukup, tetapi saya benar tidak berkutik ketika bagian B yang mengimplementasikan _node_, _topic_, dan _service_ tersebut karena jujur saya kurang dalam mempelajari _workspace_ yang diberikan
